...
class MainMenu:
        ...
        if now > self.ltng["intv_timer"] + self.ltng["intv_time"]:
            if not self.ltng["sel"]:
                if r.randint(1, 100) <= 1:
                    ...
                    self.ltng["anim"] = "in"
            if self.ltng["sel"]:
                blit_alpha(self.scr, l_img[self.ltng["sel"]], (0, 0), self.ltng["opacity"])
    ...
    def draw_buttons(self):
        ...
        self.scr.blit(self.img_panel, self.panel["pos"])
