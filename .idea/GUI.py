...
class GraphicalUserInterface:
	...
	def draw_gui(self, windows=True):
	...
	def draw_menu(self):
		...
		if self.menu_active:
			...
			IOAtlas.fade_bg('menu', 'in', self.fading_opacity)
			if IOAtlas.opacity_counter['menu'] >= self.fading_opacity:
			...
			if IOAtlas.fading['menu'] == 'out':
				IOAtlas.fade_bg('menu', 'out')
				if IOAtlas.opacity_counter['menu'] <= 0:
